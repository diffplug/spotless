...
import com.diffplug.gradle.spotless.xml.eclipse.EclipseXmlFormatterStepImpl;
...
public class TemporaryLocation implements Location {
	...
	private static URL createTemporaryDirectory() {
		try {
			Path locationPath = Files.createTempDirectory(EclipseXmlFormatterStepImpl.class.getName());
