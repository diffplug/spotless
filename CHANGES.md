...
* Improved configuration times for large projects ([#349](https://github.com/diffplug/spotless/pull/349), thanks to @oehme for finding [#348](https://github.com/diffplug/spotless/pull/348)).
