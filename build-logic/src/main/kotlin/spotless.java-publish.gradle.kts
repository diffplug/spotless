...
if (project.parent == null) {
	...
	afterEvaluate {
		...
		val javadocInfo =
			$$"<h2><a href=\"https://github.com/${org}/${rootProject.name}\" style=\"text-transform: none;\">${project.group}:${artifactId}:${project.version}</a> by <a href=\"https://www.diffplug.com\" style=\"text-transform: none;\">DiffPlug</a></h2>"
